...
CSE142 [home page](https://www.escalab.org/classes/cse142l-2023su/).
...
```
[htseng@datahub]$ git clone https://github.com/CSE142UCSD/2023su-cse142l-welcome-hungweitseng.git
...
fatal: Authentication failed for 'https://github.com/CSE142UCSD/2023su-cse142l-welcome-hungweitseng.git/'
```
